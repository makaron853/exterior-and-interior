...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'WERMATSWIL_360TOUR_INT_EXTdata/WERMATSWIL_360TOUR_INT_EXT_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'WERMATSWIL_360TOUR_INT_EXTdata/WERMATSWIL_360TOUR_INT_EXT_messages_','.xml');
}
...
function addKolorFloorPlan(pPlugID, pContent)
{
	...
	{
		var kolorFloorPlanCSS = new ktools.CssStyle("KolorFloorPlanCSS", crossDomainTargetUrl+"WERMATSWIL_360TOUR_INT_EXTdata/graphics/KolorFloorPlan/kolorFloorPlan.css");
		var kolorFloorPlanJS = new ktools.Script("KolorFloorPlanJS", crossDomainTargetUrl+"WERMATSWIL_360TOUR_INT_EXTdata/graphics/KolorFloorPlan/KolorFloorPlan.min.js", [], true);
...
function showKolorFloorPlan(pPlugID, pContent)
{
	...
	if(!kolorFloorPlan.isReady())
	{
		...
		//set url for images
		kolorFloorPlan.setGraphicsUrl(crossDomainTargetUrl+"WERMATSWIL_360TOUR_INT_EXTdata/graphics/"+pPlugID.toLowerCase()+"/");
...
function addKolorArea(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"WERMATSWIL_360TOUR_INT_EXTdata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"WERMATSWIL_360TOUR_INT_EXTdata/graphics/KolorArea/KolorArea.min.js", [], true);
